...
export const fetchItineraries = cityItinerariesToBeFetched => {
  return dispatch => {
    ...
    return fetch(`itineraries/${cityItinerariesToBeFetched}`, {
      method: "GET",
      headers: {
...
export const increaseItinerariesCount = itineraryId => dispatch => {
  ...
  axios
    .put(`itineraries/increaseitinerariestocount/${currentItinerary}`, body, {
      headers
    })
...
export const decreaseItinerariesCount = itineraryId => dispatch => {
  ...
  axios
    .put(`itineraries/decreaseitinerariestocount/${currentItinerary}`, body, {
      headers
    })
